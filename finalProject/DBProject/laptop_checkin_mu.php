    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Mizzou Memorial Union Check In</h1>                       
                        <a href="#menu-toggle" class="btn btn-default" id="menu-toggle">Toggle Menu</a>
                    </div>
                    
                    <div class="col-lg-12" align = "center">                       
                        <a href="laptop_home_mu.php" class="btn btn-default" id="home">Home</a>
                        <a href="laptop_checkout_mu.php" class="btn btn-default" id="laptop-checkout">Check Out</a>
                        <a href="laptop_checkin_mu.php" class="btn btn-default" id="laptop-checkin">Check In</a>
                        <a href = "/final/laptop_inventory_mu.php" class = "btn btn-default" id = "inventory">Inventory</a>
                    </div>
                </div>
                <div align = "center">
