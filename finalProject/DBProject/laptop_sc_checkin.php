    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Mizzou Student Center Check In</h1>                       
                    ...
                    <div class="col-lg-12" align = "center">                       
                        ...
                        <a href=".php" class="btn btn-default" id="laptop-checkin">Check In</a>
                        <a href="laptop_inventory_sc.php" class="btn btn-default" id="inventory">Inventory</a>
                    </div>
                </div>
                <div align = "center">
                    <form action = "insert_bike.php" method = "POST">
                        ...
                        <h5><em><strong>Student Waiver</strong></em></h5>
                            <input checked="check" type="radio" name="radios" value=1>Signed
