        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12" align="center"> <!-- container -->
                        <!-- <div align = "center"> -->
                    ...
                    if(isset($_POST['submit']))
                    {
                        ...
                        { 
                            case 1:
                                ...
                                if($stmt = mysqli_prepare($link, "Select * FROM item WHERE category = 'bike'")) 
                                {
...
?>
                ...
                <a href="bike_insert.php" class="btn btn-primary">Insert into Inventory</a> <!-- btn-info-->
                </div>
            </div>
        </div>
